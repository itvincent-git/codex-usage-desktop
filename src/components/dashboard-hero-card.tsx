...
export function DashboardHeroCard({ overview, range, scanMessage, lastRescanDurationMs }: DashboardHeroCardProps) {
  ...
  return (
    <Card className="overflow-hidden rounded-lg border-border/80 bg-gradient-to-br from-surface via-surface to-primary/5">
      <div className="grid gap-6 p-6 lg:grid-cols-[0.8fr_1.4fr] lg:p-8">
        <div className="flex flex-col justify-between gap-8">
          <div className="space-y-4">
            <div className="space-y-2">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-primary">Overview</p>
              <h1 className="font-display text-3xl tracking-display text-foreground sm:text-4xl">
